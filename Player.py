...
class Player:
    def __init__(self, X, Y, width, height, gunY, gunX):
        ...
        self.right_animation = Animation.Animation(["WhiteBloodCellRightWalk1.png"])
        self.left_animation = Animation.Animation(["WhiteBloodCellLeftWalk1.png"])
        self.right_walk_animation = Animation.Animation(["WhiteBloodCellRightWalk1.png", "WhiteBloodCellRightWalk2.png", "WhiteBloodCellRightWalk3.png", "WhiteBloodCellRightWalk4.png", "WhiteBloodCellRightWalk5.png", "WhiteBloodCellRightWalk6.png", "WhiteBloodCellRightWalk7.png", "WhiteBloodCellRightWalk8.png"])
        self.left_walk_animation = Animation.Animation(["WhiteBloodCellLeftWalk1.png", "WhiteBloodCellLeftWalk2.png", "WhiteBloodCellLeftWalk3.png", "WhiteBloodCellLeftWalk4.png", "WhiteBloodCellLeftWalk5.png", "WhiteBloodCellLeftWalk6.png", "WhiteBloodCellLeftWalk7.png", "WhiteBloodCellLeftWalk8.png"])
    ...
    def draw(self, screen):
        screen.blit(self.current_animation.get_current_sprite(), (self._X, self._Y))
        self.current_animation.increment_timer()
